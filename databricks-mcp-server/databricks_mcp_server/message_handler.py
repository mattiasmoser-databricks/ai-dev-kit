"""
Shared MCP message handler for both HTTP and stdio transports.
"""
import json
...
def handle_mcp_message(request_data: Dict[str, Any]) -> Dict[str, Any]:
    """
    Handle MCP JSON-RPC message and return response.
